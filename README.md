...
- **신병탁**: “??”
- **이명준**: “git을 통한 협업에 대해 얘기를 하던 도중, 시니어 개발자이신 팀원 분의 이야기를 통해 git을 통한 협업 방식을 구축하는 데에 있어 큰 관심이 생겼고, 작은 기능의 구현보다 단위 프로젝트가 나아가야할 방향성에 대한 생각을 하고 중심을 잃지 않으려고 노력하며 프로젝트를 진행했습니다. 또한, 프로젝트 상에서 내 역할이 무엇인지? 역할 분배에 미흡한 부분이 있는지를 능동적으로 확인하고, 해당 부분을 메꿔가며 팀원 분들이 진행중인 workflow에 필요하지 않은 부분이 없는지 확인하며 진행했습니다. 이를 통해 기술적인 관점에서 agent를 이용해 프로젝트를 진행을 한다면 충분히 혼자서도 할 수 있지만, 각자의 분야에서 agent를 사용하며 강점을 살리는 협업을 통한 워크플로우의 중요성을 더 크게 실감했습니다.”
